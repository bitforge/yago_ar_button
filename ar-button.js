...
export class ArButton extends LitElement {
  static get properties() {
    return {
      ...
      showQrCode: {type: Boolean, state: true},
  ...
  constructor() {
    ...
    this.model = '';
    this.buttonText = 'Default Btn Text';
    this.qrTitle = 'Default QR Title';
    this.qrText = 'Default QR Text';
    ...
    return html`
      <div
        ...
        <a
          ...
          <img />
          <!-- Purchased with royality free license on from https://thenounproject.com/term/ar/2300882/ -->
          <svg
              class="ar-icon"
  ...
  static get styles() {
    ...
    return css`${buttonStyles} ${modalStyles}`;
  }
}
