...
let ArButton = class ArButton extends LitElement {
    constructor() {
        super(...arguments);
        this.model = 'chair';
        this.qrTitle = 'Default Btn Text';
        this.qrText = 'Default QR Title';
        this.buttonText = 'Default QR Text';
        this.baseUrl = 'https://dev.yago.cloud';
        this.modelLink = '';
        this.config = {
            site_url: null,
            quicklook_link: null,
...
__decorate([
    property()
], ArButton.prototype, "model", void 0);
__decorate([
    property()
], ArButton.prototype, "qrTitle", void 0);
__decorate([
    property()
], ArButton.prototype, "qrText", void 0);
__decorate([
    property()
], ArButton.prototype, "buttonText", void 0);
__decorate([
    state()
], ArButton.prototype, "showQrCode", void 0);
__decorate([
    state()
], ArButton.prototype, "showButton", void 0);
ArButton = __decorate([
