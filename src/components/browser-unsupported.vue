<template>
    <modal-window :message="true" @close="close" class="ar-button-browser-unsupported">
        ...
        <template v-slot:default>
            <p class="content">{{ _('browser_unsupported_body')}}</p>
            <div class="copy-container">
                ...
                <button class="copy-to-clipboard" @click="copyUrl" :class="{copied: urlCopied}">
                    <svg id="copy-to-clipboard" v-if="!urlCopied" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0z" fill="none"/><path d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/></svg>
                    <svg id="success" v-if="urlCopied" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#ffffff"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm4.59-12.42L10 14.17l-2.59-2.58L6 13l4 4 8-8z"/></svg>
                </button>
            </div>
        </template>
    </modal-window>
